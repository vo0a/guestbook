...
public class FeedLoader {
    ...
    private Feed getPost(int index) throws Exception {
        ...
        List<Type> types = FunctionReturnDecoder.decode(value, outputParameters);
        Log.d("ExampleCode", "size : " + types.size());
        Log.d("ExampleCode", "name : " + types.get(0).getValue());
        Log.d("ExampleCode", "comment : " + types.get(1).getValue());
        Log.d("ExampleCode", "date : " + types.get(2).getValue());
        Log.d("ExampleCode", "emoji : " + types.get(3).getValue());
